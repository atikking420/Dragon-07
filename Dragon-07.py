...
print " %sFB%s Group%s Hack %s22-02-2020%s (20:55)%s" % (W, B, R, C, Y, N)

print " %sDevelop by: %sAtik King %s###%s Mr.Atik King%s" % (W, R, W, Y, N)
print "                      %s^^^ %sMr.Atik King%s" % (W, R, N)

print " %sCode: %sPython%s" % (W, C, N)

print " %sFB: %shttps://m.facebook.com/atik.hasan624%s" % (W, B, N)

print " %sFB: %shttps://m.facebook.com/alamin007am%s" % (W, B, N)
